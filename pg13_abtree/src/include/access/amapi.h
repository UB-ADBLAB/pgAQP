...
/* next sampled tuple */
typedef bool (*amsamplebatchtuple_function) (IndexScanDesc scan,
										     double random_number);

/* next sampled tuple */
typedef bool (*amsampletuple_function) (IndexScanDesc scan,
										double random_number);
...
typedef struct IndexAmRoutine
{
	...
	amsamplebatchtuple_function amsamplebatchtuple;
    amsampletuple_function amsampletuple; /* can be NULL */
