				 ...
				 ABTCachedAggInfo agg_info)
{
	...
	for (;;)
	{
        ...
        /* 
         * XXX(6/5/24) Potential deadlock here since we could s-lock two
         * paths in the tree for fast sampling. This needs to be fixed by
         * possibly changing the direction of lock coupling, which will
         * simplify the path locking logic as well.
         *
         * Maybe the same also applies to vacuum logic as they also do lock
         * coupling from bottom up?
         */
