...
static struct config_bool ConfigureNamesBool[] =
{
    ...
    {
        {"abtree_enable_metrics_collection", PGC_POSTMASTER, CUSTOM_OPTIONS,
            gettext_noop("Sets whether to collect run-time metrics for abtree"),
        },
        &abtree_enable_metrics_collection,
        false,
        NULL, NULL, NULL
    },

    {
        {"abtree_read_agg_bypass_version_store", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Sets whether to collect run-time metrics for abtree"),
        },
        &abtree_read_agg_bypass_version_store,
        false,
        NULL, NULL, NULL
    },

    {
        {"abtree_lock_lrpath_during_sampling", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Sets whether to collect run-time metrics for abtree"),
        },
        &abtree_lock_lrpath_during_sampling,
        false,
        NULL, NULL, NULL
    },
...
static struct config_int ConfigureNamesInt[] =
{
	...
	/*{
		{"abtree_version_store_initial_mem", PGC_POSTMASTER, CUSTOM_OPTIONS,
			gettext_noop("Sets the initial memory size to be used by abtree's "
						 "aggregate version store in MB"),
			NULL,
			GUC_UNIT_MB
		},
		&abtree_version_store_initial_mem,
		4096, 1, INT_MAX / 2,
		NULL, NULL, NULL
	}, */

	{
		{"abtree_version_store_num_buckets", PGC_POSTMASTER, CUSTOM_OPTIONS,
			gettext_noop("Sets the number of buckets in the shared hash table "
						 "of abtree's aggregate version store"),
			NULL},
		&abtree_version_store_num_buckets,
		1048576, 1024, INT_MAX,
		NULL, NULL, NULL
	},

	{
		{"abtree_version_store_garbage_collector_delay", PGC_POSTMASTER,
			CUSTOM_OPTIONS,
			gettext_noop("Sets the amount of time between two GC runs of "
						 "abtree version store in milliseconds"),
			NULL},
	...
	{
		{"abtree_metrics_reporter_delay", PGC_POSTMASTER,
			CUSTOM_OPTIONS,
			gettext_noop("Sets the amount of time between two metrics reporter "
                         "runs in abtree"),
			NULL},
	...
	{
		{"abtree_metrics_reporter_port", PGC_POSTMASTER, CONN_AUTH_SETTINGS,
			gettext_noop("Sets the TCP port the abtree metrics reporter "
                         "listens on."),
			NULL
		},
		&abtree_metrics_reporter_port,
		3002, 1, 65535,
		NULL, NULL, NULL
	},
