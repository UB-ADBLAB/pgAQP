...
#define RANDOM_VARDIST(av, sd, tgt, lower, upper) dss_random_var(av, sd, &tgt, lower, upper)
...
void		dbg_text PROTO((char * t, int min, int max, int s, DSS_HUGE numtuples, int s_len));
...
EXTERN int number_random_dates;
EXTERN float normal_distribution_av;
EXTERN float normal_distribution_av_sd;
EXTERN float normal_distribution_sd;
EXTERN int flag_front_or_back;
...
#define  L_RDTE_MIN   1
#define  L_RDTE_MAX   50
#define  L_RDTE_VAR_MIN   1
#define  L_RDTE_VAR_MAX   90
/*
...
EXTERN struct sdate_zmd s_zmd[NumTopRanksPerStream];
...
EXTERN hashmap* hashmap_order_sdate;
