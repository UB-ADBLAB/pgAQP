...
======================
# Overview
This is the code base for OptiAQP: Index-Assisted Stratified Sampling for Online Aggregation (ICDE '27) [arXiv preprint](https://arxiv.org/abs/2604.28141). In this work, we design optimized index-assisted stratified sampling method for online aggregation style approximate query processing. This improves approximate query latency when there is high data variance and/or selective predicates.
